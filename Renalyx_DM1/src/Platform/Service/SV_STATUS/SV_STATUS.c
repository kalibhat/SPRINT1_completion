...
uint16_t sv_status_getsystemstatus(Sys_statusType* sensor_struct)
{
	...
	sensor_struct1.Thermocouple			= DD_CAN_READ_SENSORS(DD_CAN_SENSOR_ID4);    //Gopal: Thermo couple 07112017
...
//	sensor_struct1.cond_wien_status		= DD_READ_SENSORS(SV_SENSOR_ID12);
	sensor_struct1.cond_DAA				= DD_CAN_READ_SENSORS(DD_CAN_SENSOR_ID15);
	sensor_struct1.cond_DAB				= DD_CAN_READ_SENSORS(DD_CAN_SENSOR_ID16);
	sensor_struct1.cond_DAC2			= DD_CAN_READ_SENSORS(DD_CAN_SENSOR_ID17);
	...
	sensor_struct->Thermocouple			= sensor_struct1.Thermocouple;  // Gopal: Thermo couple 07112017

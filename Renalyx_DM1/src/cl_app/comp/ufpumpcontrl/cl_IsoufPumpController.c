...
Cl_ReturnCodeType Cl_Isouf_ResetAlertsforReassertion(void )
{
	...
	Cl_IsoufAlarmTable[CL_DLSIS_ALARM_COND_STATUS_LOW].IsRaised = false;
	Cl_IsoufAlarmTable[CL_DLSIS_ALARM_COND_STATUS_HIGH].IsRaised = false;
	Cl_AlarmResetAlarm(COND_STATUS_LOW);
	Cl_AlarmResetAlarm(COND_STATUS_HIGH);

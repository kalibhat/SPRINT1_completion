...
//	Cl_Uint8Type start1,start2,command,datasize,data1,data2,end1,end2;
	...
	//printf("#/n");
			...
			{
				// check for sync from ui
				if(Cl_ConsoleRxMsg.data.byte[0] == CON_RX_COMMAND_SYNC){
...
//		printf("J/n");
		...
		*MacEvent =EVT_CONSOLE_COMMAND_DIALYSIS_ISOUF_OFF;
		break;
		case CON_RX_EVT_COMMAND_STOP_DISINF:
		*MacEvent =EVT_CONSOLE_COMMAND_STOP_DISINF;
		break;
		default:
		break;
	}

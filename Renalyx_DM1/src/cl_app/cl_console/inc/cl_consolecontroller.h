...
typedef enum {
			...
			CON_RX_EVT_COMMAND_DLSIS_ISOUF_ON,  //  54,
			CON_RX_EVT_COMMAND_DLSIS_ISOUF_OFF, //55
			CON_RX_COMMAND_SELFTEST_START,
			CON_RX_COMMAND_SELFTEST_ALARM_OK,
			CON_RX_COMMAND_SELFTEST_ALARM_FAIL,
			CON_RX_COMMAND_SELFTEST_STOP,
			CON_RX_COMMAND_SYNCCONFIMED,
//				CON_RX_COMMAND_SELFTEST_START,           //for selftest
//				CON_RX_COMMAND_SELFTEST_STOP,   ////for selftest
...
typedef enum{
			...
			CON_TX_COMMAND_ALARM_CLEARED,
			CON_TX_COMMAND_SELFTEST_STARTED,
			CON_TX_COMMAND_SELFTEST_PASSED,
			CON_TX_COMMAND_SELFTEST_FAILED,
			CON_TX_COMMAND_SELFTEST_REPORT,
			CON_TX_COMMAND_SELFTEST_START_ALARM,
			CON_TX_COMMAND_SELFTEST_STOPPED,
			CON_TX_COMMAND_SELFTEST_SYNC_CHECK,

...
Cl_Uint32Type uf_fb_lower , uf_fb_upper;
...
volatile uf ufp[18] = {
	...
	//	{10,6000,6820,6840},{20,3000,3400,3420},{30,2100,2380,2400},{40,1500,1700,1720},{50,800,1360,1380},{60,1050,1180,1200},{70,800,900,920},{80,675,740,760},{90,625,700,720},{100,600,680,700},{110,500,560,580},{120,450,500,520},{130,425,480,500},{140,400,440,460},{150,375,420,440},{170,325,380,400},{200,250},{250,200},{340,150}
	//	{10,6000,6820,6840},{20,3000,3400,3420},{30,2100,2380,2400},{40,1500,1700,1720},{50,800,1360,1380},{60,1050,1180,1200},{70,800,900,920},{80,675,740,760},{90,625,700,720},{100,600,680,700},{110,500,560,580},{120,450,500,520},{130,425,480,500},{140,400,440,460},{150,375,420,440},{160,350,400,420},{170,325,380,400}
		{10,6000,6800,7000},{20,3000,3350,3450},{30,2100,2400,2500},{40,1500,1700,1750},{50,800,1350,1400},{60,1050,1200,1250},{70,800,850,900},{80,675,750,800},{90,625,700,750},{100,600,650,700},{110,500,600,650},{120,450,500,550},{130,425,450,500},{140,400,400,450},{150,375,400,450},{160,325,350,400},{170,275,300,350}
};
...
{
{50,700,50},{60,750,57},{65,750,64},{70,760,100},{75,780,105},{80,780,120},{85,780,130},{90,780,150},{95,780,170},{100,970,200},{110,1000,210},{120,1030,220},
{140,1030,230},{150,970,270},{200,1250,330},{300,1300,430},{400,1350,600}
	...
	for (i=0;i<18;i++)
		{
			if (dummy_var == ufp[i].rate)
			{
				...
				uf_final=dummy_var1;
				uf_fb_lower = ufp[i].uf_fblower;
				uf_fb_upper = ufp[i].uf_fbupper;
				break;
			}
			else if ((dummy_var > ufp[i].rate) && (dummy_var < ufp[i+1].rate))
			{
				...
				//temprature_final_value =1500;
					slope = (ufp[i+1].uf_fblower-ufp[i].uf_fblower)/(ufp[i+1].rate-ufp[i].rate);
					uf_fb_lower = slope * (dummy_var-ufp[i].rate) + ufp[i].uf_fblower;
					slope = (ufp[i+1].uf_fbupper-ufp[i].uf_fbupper)/(ufp[i+1].rate-ufp[i].rate);
					uf_fb_upper = slope * (dummy_var-ufp[i].rate) + ufp[i].uf_fbupper;
